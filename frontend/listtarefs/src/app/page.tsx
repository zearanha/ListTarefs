  ...
  return (
    ...
    <div className="bg-slate-200 flex justify-center items-center h-screen">
      <div className="flex justify-center items-center flex-col">
        ...
        <Button type="button" onClick={() => router.push('/login')} className="bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white font-bold py-2 px-4 rounded-4xl transform active:scale-90 transition-transform duration-300 cursor-pointer mb-4">Entrar</Button>
